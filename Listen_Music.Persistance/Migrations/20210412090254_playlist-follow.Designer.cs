...
namespace Listen_Music.Persistance.Migrations
{
    ...
    [Migration("20210412090254_playlist-follow")]
    partial class playlistfollow
    {
            ...
            modelBuilder.Entity("Listen_Music.Domain.Entities.Users.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            InsertTime = new DateTime(2021, 4, 12, 13, 32, 54, 391, DateTimeKind.Local).AddTicks(9720),
                            IsRemoved = false,
                            Name = "Admin"
                        },
                        new
                        {
                            Id = 2L,
                            InsertTime = new DateTime(2021, 4, 12, 13, 32, 54, 395, DateTimeKind.Local).AddTicks(6401),
                            IsRemoved = false,
                            Name = "User"
                        });
                });
