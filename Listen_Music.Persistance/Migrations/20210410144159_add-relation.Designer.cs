...
namespace Listen_Music.Persistance.Migrations
{
    ...
    [Migration("20210410144159_add-relation")]
            ...
            modelBuilder.Entity("Listen_Music.Domain.Entities.Users.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            InsertTime = new DateTime(2021, 4, 10, 19, 11, 58, 531, DateTimeKind.Local).AddTicks(5317),
                            IsRemoved = false,
                            Name = "Admin"
                        },
                        new
                        {
                            Id = 2L,
                            InsertTime = new DateTime(2021, 4, 10, 19, 11, 58, 535, DateTimeKind.Local).AddTicks(5854),
                            IsRemoved = false,
                            Name = "User"
                        });
                });
