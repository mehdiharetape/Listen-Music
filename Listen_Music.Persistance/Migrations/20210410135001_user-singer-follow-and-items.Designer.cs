...
namespace Listen_Music.Persistance.Migrations
{
    ...
    [Migration("20210410135001_user-singer-follow-and-items")]
    partial class usersingerfollowanditems
    {
            ...
            modelBuilder.Entity("Listen_Music.Domain.Entities.Users.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            InsertTime = new DateTime(2021, 4, 10, 18, 20, 1, 92, DateTimeKind.Local).AddTicks(6678),
                            IsRemoved = false,
                            Name = "Admin"
                        },
                        new
                        {
                            Id = 2L,
                            InsertTime = new DateTime(2021, 4, 10, 18, 20, 1, 96, DateTimeKind.Local).AddTicks(3268),
                            IsRemoved = false,
                            Name = "User"
                        });
                });
